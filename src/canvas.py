...
class CameraWidget(QWidget):
    ...
    def draw_ocr_overlay(self, hasil: list, frame_shape: tuple) -> None:
        """
        Gambar bounding box hasil OCR di atas frame saat ini.
        Dipanggil dari MainWindow setelah OCR selesai.
        Simpan hasil di internal state; paintEvent akan render-nya.
        """
        # Untuk sekarang bisa diextend: simpan hasil ke self._ocr_results
        # dan gambar di paintEvent setelah frame. Placeholder untuk integrasi OCR.
        pass
